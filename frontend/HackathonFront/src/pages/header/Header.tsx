...
const Header = ( ) => {
 ...
 {/*<div className="  w-5 h-full      "
  ...
  <div className="flex flex-col  w-28 h-[873px] rounded-[40px]   bg-[#1B4B8B] text-white flex flex-col   p-4">
      {/* Вміст хедера */}
      <div className="flex-grow flex flex-col justify-start"><a href="/userlayout/post" className="mx-5 my-5 rounded-[40px] "><img src="../../../../public/posts carousel vertical.svg" alt="" /></a>
      </div>
