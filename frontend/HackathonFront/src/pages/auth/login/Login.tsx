...
import Banner from '../../../../public/login_ph.png';
    ...
    <>
      <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
        ...
        <div className="  w-full   bg-[white]">
          ...
          <h1 className="mt-[180px] text-left mx-20 text-black text-[33px]">Вхід</h1>
          ...
          <form onSubmit={handleSubmit} className="my-5 max-w-md mx-auto">
            ...
            <div className="relative z-0 w-full mb-5 group">
              <input onChange={handleChange} type="password" name="password" id="password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
