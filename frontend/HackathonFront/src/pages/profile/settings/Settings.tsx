  ...
  <form action=""  method="POST" className="  mt-[3rem]   ">
    <div className="grid grid-cols-1 gap-x-24 gap-y-20 sm:grid-cols-2">
      ...
      <div className="sm:col-span-2">
        ...
        <div className="mt-2.5">
          <textarea name="aboutme" placeholder="Про мене" onChange={handleInputChange} value={userData.aboutme}     id="aboutme"  className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
        </div>
      </div>
